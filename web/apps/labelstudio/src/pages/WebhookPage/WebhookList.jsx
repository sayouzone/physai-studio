        ...
        {webhooks.length === 0 ? (
          <SimpleCard title="" className="bg-primary-background border-primary-border-subtler p-base">
            <EmptyState
              ...
              description="Setup integrations that subscribe to certain events using Webhooks. When an event is triggered, PhysAI Studio sends an HTTP POST request to the configured webhook URL."
              actions={
                canChangeWebhooks ? (
