  ...
  return (
    <>
      <Alert variant="destructive">
        ...
        <AlertDescription>
          Set the "LOCAL_FILES_SERVING_ENABLED" environment variable to "true" and restart PhysAI Studio to enable Local
...
export const localFilesProvider: ProviderConfig = {
  name: "localfiles",
  title: "Local Files",
  description: "Configure your local file storage connection with all required PhysAI Studio settings",
  icon: () => (
    <IconFolderOpen
      width={40}
      height={40}
  ...
  fields: [
    ...
    },
    {
      ...
      description: `This path must be an absolute path on the host machine where PhysAI Studio is running and start with \n"${localFilesDocumentRoot}" (LOCAL_FILES_DOCUMENT_ROOT).`,
    },
  ],
