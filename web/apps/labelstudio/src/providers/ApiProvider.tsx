...
// Initialize API instance with PhysAI Studio configuration
...
/**
 * PhysAI Studio application-specific ApiProvider.
 * Wraps the core ApiProvider with PhysAI Studio-specific error handling.
 */
export const ApiProvider = forwardRef<ApiContextType, PropsWithChildren<Record<string, never>>>(({ children }, ref) => {
  const toast = useToast();

  /**
   * Handles errors with PhysAI Studio-specific logic including:
