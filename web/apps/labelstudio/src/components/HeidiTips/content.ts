...
export const defaultTipsCollection: TipsCollection = {
  projectCreation: [
    {
      title: "Did you know?",
      content: "It’s easier to find the projects when you organize them into workspaces using PhysAI Studio Enterprise.",
      closable: true,
      link: {
        label: "Learn more",
    ...
    },
    {
      ...
      content:
        "Streamline assigning staff to multiple projects by assigning them to workspaces in PhysAI Studio Enterprise.",
      closable: true,
      link: {
        label: "Learn more",
    ...
    },
    {
      title: "Did you know?",
      content:
        "You can control access to specific projects and workspaces for internal team members and external annotators using PhysAI Studio Enterprise.",
      closable: true,
      link: {
        label: "Learn more",
    ...
    },
    {
      ...
      content:
        "PhysAI Studio has templates available for supervised LLM fine-tuning, RAG retrieval ranking, RLHF, chatbot evaluation, and more.",
      closable: true,
      link: {
  ...
  organizationPage: [
    {
      ...
      content:
        "Assign roles to your team using PhysAI Studio Enterprise and control access to sensitive data at the project and workspace levels.",
      closable: true,
      link: {
        label: "Learn more",
        url: "https://docs.humansignal.com/guide/manage_users#Roles-in-Label-Studio-Enterprise",
    ...
    },
    {
      ...
      content: "Enable Single Sign-On for your team using SAML, SCIM2 or LDAP with PhysAI Studio Enterprise.",
      closable: true,
      link: {
        label: "Learn more",
    ...
    {
      title: "Did you know?",
      content: "Try PhysAI Studio Starter Cloud, optimized for small teams and projects.",
      closable: true,
      link: {
        label: "Learn more",
    ...
    },
    {
      ...
      content:
        "Have questions or a tip to share with other PhysAI Studio users? Join the community slack channel for the latest updates. ",
      closable: true,
      link: {
    ...
    },
    {
      title: "Did you know?",
      content:
        "PhysAI Studio supports multiple points of integration with cloud storage, machine learning models, and popular tools to automate your machine learning pipeline.",
      closable: true,
      link: {
  ...
  projectSettings: [
    {
      title: "Apply your AWS spend to PhysAI Studio Enterprise",
      content:
        "PhysAI Studio Enterprise is now available on the AWS Marketplace so you can use your committed spend to streamline data labeling workflows.",
      closable: true,
      link: {
        label: "Learn more",
    ...
    },
    {
      title: "Did you know?",
      content:
        "You can increase the quality of your labeled data with reviewer workflows and task agreement scores using PhysAI Studio Enterprise.",
      closable: true,
      link: {
        label: "Learn more",
