import { IconEyeClosed, IconEyeOpened, IconPlus, IconRelationLink, IconDuplicate, IconAnalytics, IconTrash, IconWarning } from "@humansignal/icons";
...
import { GeoreferencingButton } from "../../Common/GeoreferencingButton";
    ...
    <div className={cn("region-actions").toClassName()}>
      ...
      <div className={cn("region-actions").elem("group").mod({ align: "right" }).toClassName()}>
        ...
        <RegionActionButton
          variant="negative"
          look="string"
          aria-label="Duplicate selected region"
          disabled={region.isReadOnly()}
          tooltip="Duplicate selected region"
          onClick={() => annotation.duplicateRegion(region)}
        >
          <IconDuplicate />
        </RegionActionButton>

        <GeoreferencingButton region={region} />
