 ...
 * </View>
 * @example
 * <!--Labeling configuration for time series data stored in the task field `ts` in PhysAI Studio JSON format. The time field is stored as a date in the `timeformat` field and formatted as a full date on the plot (by default). -->
 * <View>
 ...
 * @meta_description Customize PhysAI Studio with the TimeSeries tag to annotate time series data for machine learning and data science projects.
 ...
 * @param {url|json} [valueType=url] Format of time series data provided. If set to "url" then PhysAI Studio loads value references inside `value` key, otherwise it expects JSON.
    ...
    get dataObj() {
      ...
      if (!self.timecolumn) {
        ...
        const message = [
          ...
          `<a href="${getEnv(self).messages.URL_TAGS_DOCS
          ...
          if (current < previous) {
            ...
            throw new Error(
              [
                ...
                `<br/><a href="${getEnv(self).messages.URL_TAGS_DOCS
