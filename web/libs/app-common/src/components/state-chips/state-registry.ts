/**
 * State Registry System for PhysAI Studio
 *
 * This module provides an extensible state management system that allows
 * PhysAI Studio Enterprise to extend state definitions without modifying base code.
 *
...
// ============================================================================
// Core State Registrations (PhysAI Studio Open Source)
// ============================================================================
