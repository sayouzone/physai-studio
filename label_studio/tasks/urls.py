...
_api_urlpatterns = [
    ...
    path('<int:pk>/georeferencing', api.TaskGeoreferencingAPI.as_view(), name='task-georeferencing'),
    path(
    ...
    path('<int:pk>/footprint/', TaskFootprintAPI.as_view(), name='task-footprint'),
]
...
_api_annotations_urlpatterns = [
    ...
    path('<str:pk>/georeferencing', api.AnnotationGeoreferencingAPI.as_view(), name='annotation-georeferencing'),
]
