...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--panel-unit-glint", dest="panel_unit_glint_weight",
                   ...
                   help="패널 단위를 고를 때 반사(포화) 회피 가중치. 0 이면 k "
                        "만 본다. 실측에서 패널의 5%%가 반사로 포화돼 판독이 "
                        "불가능했고, 0.5 로 반사 프레임 사용이 절반으로 줄었다")
...
def main() -> None:
    ...
    if args.check_version:
        ...
        _need = ["coarse_ba_ftol", "fine_gate_auto", "auto_distortion",
                 ...
                 "panel_unit_m", "seam_panel_penalty",
        ...
        try:
            ...
            for _mod, _fn in [("panel_units", "consolidate_labels_by_unit"),
